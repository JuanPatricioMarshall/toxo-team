...
function playerCreate(first_name, family_name,d_birth,  nickname,   score , cb) {
    playerdetail = {first_name:first_name , family_name: family_name }
    if (d_birth != false) playerdetail.date_of_birth = d_birth
    playerdetail.score = score
    playerdetail.nick = nickname
...
function createPlayers(cb) {
    async.parallel([
            function(callback) {
                playerCreate('Edu', 'Neira', '1973-06-06', 'el cometravas', 7, callback);
            },
            function(callback) {
                playerCreate('Lautaro', 'Pereyra', '1913-06-06', 'manco', 6, callback);
            },
            function(callback) {
                playerCreate('Gabriel', 'Gayoso', '1920-01-02', 'el bambino',7, callback);
            },
            function(callback) {
                playerCreate('Tito', 'Farias', '1990-01-02', 'el comepapas',5, callback);
            },
            function(callback) {
                playerCreate('Juan', 'Petrillo', '1970-01-02', 'Juanma',6, callback);
            },
        ],
        // optional callback
        cb);
